...
ADMINS = ()
ALLOWED_HOSTS = ['payments-altdev.allizom.org', 'localhost']
...
SITE_URL = 'https://payments-altdev.allizom.org'
...
ZIPPY_PROXY = 'https://payments-proxy-altdev.allizom.org/proxy/provider'
ZIPPY_CONFIGURATION = {
    'reference': {
...
PAYPAL_URL_WHITELIST = ('https://marketplace-altdev.allizom.org',)

BANGO_BASIC_AUTH = private.BANGO_BASIC_AUTH
BANGO_FAKE_REFUNDS = True
BANGO_PROXY = private.BANGO_PROXY
BANGO_NOTIFICATION_URL = (
    'https://marketplace-altdev.allizom.org/mozpay/bango/notification')
