...
SYSLOG_TAG = 'http_app_payments_s3dev'
...
SITE_URL = 'https://payments-s3dev.allizom.org'

S3_AUTH = {'key': private.S3_AUTH_KEY, 'secret': private.S3_AUTH_SECRET}
S3_BUCKET = private.S3_BUCKET

NEWRELIC_INI = '/etc/newrelic.d/payments-s3dev.allizom.org.ini'

# Below is configuration of payment providers.

ZIPPY_PROXY = 'https://payments-proxy-s3dev.allizom.org/proxy/provider'
ZIPPY_CONFIGURATION = {
    'reference': {
...
BANGO_NOTIFICATION_URL = (
    'https://marketplace-s3dev.allizom.org/mozpay/bango/notification')
